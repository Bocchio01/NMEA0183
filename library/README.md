...
To know more about the library structure, please refer to the generated [documentation](docs/html/index.html).

## Apps

In the `apps` folder you can find:

- `main.c`: a program used to import the library and run with a couple of simulated data
- `bench.c`: a program that can be used to benchmark the library and save the results
...
As a build system, we use `CMake`.

### Copy the code to the ESP32 project

You can copy the code to the ESP32 project by typing:
